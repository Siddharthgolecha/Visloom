...
Ship ADRs 0007-0018 (data, observability, media, versioning, transport, privacy) plus remaining docs/conventions/*.md and docs/privacy.md. Docs only. ≤ 400 LOC. Depends on part-1 for the ADR template + events/api naming.
