...
Ship the ADR framework and the four locked-fork ADRs (0001-0006) plus docs/conventions/{coding,events,api}.md. Docs only, no code. Cites the approved arch-scaffold epic plan. ≤ 350 LOC. See parent issue for locked architectural forks.
